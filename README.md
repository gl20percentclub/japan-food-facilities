...
> | 都道府県 | 47 |
> | 市区町村 | 1,726 |
> | うち市区町村を特定できない施設 | 37,558 件 |
> | 結合CSV | 約 401.1 MB |
> | 都道府県別CSV | 47 ファイル / 約 401.1 MB |
> | ベクトルタイル | 8,770 枚 / 約 438.7 MB |
<!-- STATS:END -->
...
詳細は[metadata.json](https://food.japan-facilities.com/api/tiles/metadata.json)を参照してください（まとめ方の設定は `thinning`）。
